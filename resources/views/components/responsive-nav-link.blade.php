...
$classes = ($active ?? false)
            ? 'block w-full ps-3 pe-4 py-2 border-l-4 border-university-700 text-start text-base font-medium text-university-700 bg-university-50 focus:outline-none focus:text-university-800 focus:bg-university-100 focus:border-university-800 transition duration-150 ease-in-out'
