        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="mt-1 text-sm text-slate-600">
                    <span class="font-mono font-semibold text-university-700">{{ $estudiante->cedula }}</span> - {{ $estudiante->nombre_completo }}
                </p>
            </div>
        ...
        <div class="university-card">
            <div class="university-card-header">
                <div class="flex items-center">
                    ...
                    <h3 class="text-lg font-semibold">Modificar Información del Estudiante</h3>
                </div>
            </div>
